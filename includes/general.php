...
{
    global $db;
    return $db->get_var("SELECT option_value FROM options_tb WHERE option_name='$option_name'");
}

function update_option($option_name, $option_value)
{
    global $db;
    return $db->query("UPDATE options_tb SET option_value='$option_value' WHERE option_name='$option_name'");
}
